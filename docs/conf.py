...
htmlhelp_basename = 'scprisma'
html_theme = 'sphinx_rtd_theme'
file_insertion_enabled = False
latex_documents = [
  ('index', 'scprisma.tex', u'scPrisma Documentation',
   u'', 'manual'),
]
...
context = {
    ...
    'downloads': [ 
    ("html", "//scprisma.readthedocs.io/_/downloads/en/latest/htmlzip/"),
    ],
    'subprojects': [ 
    ],
    'slug': 'scprisma',
    ...
    'canonical_url': 'https://scprisma.readthedocs.io/en/latest/',
    'analytics_code': 'None',
    'single_version': False,
    'conf_py_path': '/docs/',
    'api_host': 'https://readthedocs.org',
    'github_user': 'nitzanlab',
    'proxied_api_host': '/_',
    'github_repo': 'scPrisma',
...
if 'branch' == 'external':
    ...
    readthedocs_build_url = 'https://readthedocs.org/projects/scprisma/builds/18681643/'
